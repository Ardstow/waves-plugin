...
3. **修改远程仓库地址**
   ```bash
   git remote set-url origin https://github.com/Ardstow/waves-plugin.git
   ```
...
4. **验证修改是否成功**
   ...
   现在应该显示新的仓库地址：
   ```
   origin  https://github.com/Ardstow/waves-plugin.git (fetch)
   origin  https://github.com/Ardstow/waves-plugin.git (push)
   ```
